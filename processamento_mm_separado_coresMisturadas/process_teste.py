...
#filtros de dilatacao em todas as mascaras
...
cv2.imshow("imagem final processada",and_mask)
cv2.imshow("teste",yellow_mask)

#cv2.imshow("imagem  blue",first_brow_mask)
